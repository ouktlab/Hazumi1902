...
questionnaire/1902questionnaire.xlsx		アンケート結果
questionnaire/1902questionnaire-items.pdf	使用した質問紙

アンケート結果のファイルには4つのタブがあり，実験参加者（実験前），実験
参加者（実験後），Wizard（実験前），Wizard（実験後）である．このそれぞれ
において，実験参加者は18項目，Wizardは簡略化した3項目に対して，8段階で回
答した結果が記録されている．詳しくは概要説明書を参照のこと．
